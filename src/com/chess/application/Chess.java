...
public class Chess extends Application {
	...
	public void getSettingsScreen(Stage stage) {
		try {
			...
			scene.getStylesheets().add(Objects.requireNonNull(Chess.class.getClassLoader().getResource("com/chess/resources/application.css")).toExternalForm());
			if (stage == null) {
				stage = new Stage();
